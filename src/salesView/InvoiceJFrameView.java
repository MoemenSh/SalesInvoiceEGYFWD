...
public class InvoiceJFrameView extends javax.swing.JFrame {

  
    public InvoiceJFrameView() {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InvoiceJFrameView().setVisible(true);
            }
        });
    }
    ...
    private Actions controller = new Actions(this);
    private InvoicesJTableView invoicesTableModel;
    ...
    public InvoicesJTableView getInvoicesTableModel() {
        if (invoicesTableModel == null) {
            invoicesTableModel = new InvoicesJTableView(getInvoices());
        }
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(InvoicesJTableView invoicesTableModel) {
